  ...
  return (
    <>
      <div className="container mx-auto px-4 py-8 pt-20 ">
        <header className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-8 ">
          <img
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mt-28 px-4">
          <div className="bg-white bg-opacity-30 rounded-lg shadow-md overflow-hidden">
            ...
            <Link
              to="/services"
              className="text-gray-900  bg-gradient-to-r from-teal-200 to-lime-200 hover:bg-gradient-to-l hover:from-teal-200 hover:to-lime-200 focus:ring-4 focus:outline-none focus:ring-lime-200 dark:focus:ring-teal-700 font-medium rounded-lg "
            >
              Description/Details
            </Link>
          </div>
      ...
      <Link to="/Subscription">
        <div className="w-full  mx-auto mt-6 max-w-7xl ">
          <div className="relative w-full h-64 bg-white rounded-lg overflow-hidden">
            <img
              src="https://ulesson.com/blog/wp-content/uploads/2023/03/Artboard-%CE%93Co-34.png"
      ...
      <footer className="w-full  mx-auto mt-6 max-w-7xl ">
        <Link to="/Product">
          <div className="relative w-full h-64 bg-white rounded-lg overflow-hidden">
            <img
              src="https://www.shutterstock.com/image-vector/new-product-logo-design-template-260nw-1806076264.jpg"
              className="absolute object-cover w-full h-full "
            />
          </div>
        </Link>
        <Link to="/Services">
          <div className="relative w-full h-64 bg-white rounded-lg overflow-hidden mt-6">
            <img
              src="https://wallpapers.com/images/featured/car-wash-0d91u3sqo0qw441a.jpg"
              className="absolute object-cover w-full h-full "
            />
          </div>
        </Link>
        <Link to="/WhoWeAre">
          <div className="relative w-full h-64 bg-white rounded-lg overflow-hidden mt-6">
            <img
              src="https://www.shutterstock.com/image-photo/word-history-written-dirty-vintage-260nw-363741776.jpg"
              className="absolute object-cover w-full h-full "
            />
          </div>
        </Link>
